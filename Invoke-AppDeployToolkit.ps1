...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses sldProdMon,SLDWORKS,sldworks_fs -CheckDiskSpace -PersistPrompt
    ...
    Start-ADTProcess -FilePath "startswinstall.exe" -ArgumentList "/install /now"
